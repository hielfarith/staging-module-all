                ...
                <div class="user-avatar-section">
                    <div class="d-flex align-items-center flex-column">
                        <span class="avatar bg-light-secondary p-50">
                            <span class="avatar-content">Seqy</span>
                            <span class="avatar-status-online"></span>
                        </span>
                        <br>
                        <div class="user-info text-center">
                            <h3 class="fw-bolder mb-1">Seqy</h3>
                ...
                <div class="table-responsive">
                    <table class="table" width="100%">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" value="Seqy">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" value="Seqy@email.com">
                            </td>
                        </tr>
