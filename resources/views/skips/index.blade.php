...
@section('content')
    ...
    <ul class="nav nav-pills nav-first nav-justified" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder active" id="butiran-institusi-tab" data-bs-toggle="tab"
                href="#butiran-institusi" aria-controls="butiran-institusi" role="tab" aria-selected="true"
                onclick="tabclicked('#butiran-institusi')">
                BUTIRAN INSTITUSI
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder" id="item-tab" data-bs-toggle="tab" href="#item"
                aria-controls="item" role="tab" aria-selected="true" onclick="tabclicked('#item')">
                ITEM STANDARD KUALITI
            </a>
        </li>
        @if ($type == 'verfikasi')
            <li class="nav-item" role="presentation">
                <a class="text-uppercase text-wrap nav-link fw-bolder" id="item-verifikasi-tab" data-bs-toggle="tab"
                    href="#item-verifikasi" aria-controls="item-verifikasi" role="tab" aria-selected="true"
                    onclick="tabclicked('#item-verifikasi')">
        ...
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder" id="skor-item-tab" data-bs-toggle="tab" href="#skor-item"
                aria-controls="skor-item" role="tab" aria-selected="true" onclick="tabclicked('#skor-item')">
        ...
        @if ($type == 'verfikasi')
            ...
            <li class="nav-item" role="presentation">
                <a class="text-uppercase text-wrap nav-link fw-bolder" id="butiran-pemeriksaan-tab" data-bs-toggle="tab"
                    ...
                    onclick="tabclicked('#butiran-pemeriksaan')">
                    BUTIRAN PEMERIKSAAN
                </a>
            </li>
        @endif
        @if ($type == 'validasi')
            <li class="nav-item" role="presentation">
                <a class="text-uppercase text-wrap nav-link fw-bolder" id="ulasan-tab" data-bs-toggle="tab" href="#ulasan"
                    aria-controls="ulasan" role="tab" aria-selected="true" onclick="tabclicked('#ulasan')">
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="item-verifikasi" role="tabpanel" aria-labelledby="item-verifikasi-tab">
                    @include('skips.index_item_verfikasi', [
                        'type' => 'verfikasi',
                        'tab_name' => 'item_verfikasi',
                    ])
                </div>
