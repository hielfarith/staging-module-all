...
@section('content')
    ...
    <ul class="nav nav-pills nav-first nav-justified" role="tablist">
        ...
        <li style="bg-color:black;font-size: 10pt" class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder active" id="aspek-1-tab" data-bs-toggle="tab"
                href="#aspek-1" aria-controls="aspek-1" role="tab" aria-selected="true">
                ASPEK 1
            </a>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder" id="jumlah-tab" data-bs-toggle="tab" href="#jumlahspks"
                aria-controls="jumlah" role="tab" aria-selected="false" onclick="jumlahspks()">
                JUMLAH
            </a>
        </li>
    </ul>
