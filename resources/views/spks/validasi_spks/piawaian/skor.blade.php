...
<div class="card-header d-flex justify-content-between align-items-center">
    ...
    <div style="padding-top:1% " class="content-end align-items-center">
        <p style="background-color: #0C2043;color:white;padding: 5px 10px;font-weight:bold">Status Sekolah: <span></span></p>
    </div>
</div>
