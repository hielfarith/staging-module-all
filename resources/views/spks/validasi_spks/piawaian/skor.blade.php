        ...
        <table class="table header_uppercase table-bordered table-hovered" id="jumlahKeseluruhanSpks">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size: 9pt" class="text-center" id="count1">0</td>
                    <td style="font-size: 9pt" class="text-center" id="percentage1">0.00</td>
                </tr>
                <tr>
                    ...
                    <td style="font-size: 9pt" class="text-center" id="count2">0</td>
                    <td style="font-size: 9pt" class="text-center" id="percentage2">0.00</td>
                </tr>
                <tr>
                    ...
                    <td style="font-size: 9pt" class="text-center" id="count3">0</td>
                    <td style="font-size: 9pt" class="text-center" id="percentage3">0.00</td>
                </tr>
                <tr>
                    ...
                    <td style="font-size: 9pt" class="text-center" id="count4">0</td>
                    <td style="font-size: 9pt" class="text-center" id="percentage4">0.00</td>
                </tr>
                <tr>
                    ...
                    <td style="font-size: 9pt" class="text-center" id="count5">0</td>
                    <td style="font-size: 9pt" class="text-center" id="percentage5">0.00</td>
                </tr>
                <tr>
                    ...
                    <td style="font-size: 9pt" class="text-center" id="count6">0</td>
                    <td style="font-size: 9pt" class="text-center" id="percentage6">0.00</td>
                </tr>
