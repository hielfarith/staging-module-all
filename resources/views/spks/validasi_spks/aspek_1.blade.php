            ...
            <tr id="pengisianAspek1_{{ $index }}_{{ $loop->index }}">
                <td colspan="6" class="bg-light-warning">
                    <div class="input-group">
                        ...
                        <button class="btn btn-success btn-sm" type="button" id="checkAspek1_{{ $index }}_{{ $loop->index }}">
                            <i class="fa fa-check" aria-hidden="true"></i>
                        </button>
                        <button class="btn btn-danger btn-sm" type="button" id="rejectAspek1_{{ $index }}_{{ $loop->index }}">
