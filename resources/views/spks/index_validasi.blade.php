    ...
    <ul class="nav nav-pills nav-justified" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder" id="validasi-skor-tab" data-bs-toggle="tab"
                href="#validasi-skor" aria-controls="validasi-skor" role="tab" aria-selected="false" onclick="choosetabSkorvalidasi()">
                SKOR PIAWAIAN
            </a>
        </li>
        ...
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder" id="catatan-validasi-tab" data-bs-toggle="tab"
                ...
                onclick="choosetabvalidasi('ringkasan_catatan')">
                RINGKASAN CATATAN
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder" id="jpn-verifikasi-tab" data-bs-toggle="tab"
                ...
                onclick="choosetabvalidasi('validasi_kpm')">
                VALIDASI KPM
            </a>
        </li>
    </ul>
...
<script type="text/javascript">
    ...
    function choosetabMain(argument) {
     ...
     function choosetabSkorvalidasi() {
    ...
    function  choosetabvalidasi(argument) {

        if (argument == 'ringkasan_catatan' || argument == 'validasi_kpm') {
            ...
            $.ajax({
                ...
                success: function(response) {
                   // write the loop
                    // 1. aspek 1
                   $('#catatan_sekolah_body_validasi').empty();
                   $('#catatan_sekolah_jpn_validasi').empty();
                    var j =1;
                    ...
                    for (var i = 1; i <= 10; i++) {
                        ...
                        if (Object.keys(data).length > 0) {
                            Object.keys(data).forEach(key => {
                                ...
                                tableringaskanData = tableringaskanData + '<td style="font-size: 9pt; width:10%"><textarea style="font-size: 9pt" rows="5" class="form-control" name="catatan_'+aspek+'_'+key+'" disabled>'+catatan+'</textarea></td>';
