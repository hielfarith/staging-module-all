                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    <input required class="form-check-input radio-input-2" type="radio"
                                        ...
                                        @if (isset($aspek1_sectionc) && $aspek1_sectionc[$nameIndex] == '0') checked @endif {{ $disabled }}>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    <input required class="form-check-input radio-input-2" type="radio"
                                        ...
                                        @if (isset($aspek1_sectionc) && $aspek1_sectionc[$nameIndex] == '1') checked @endif {{ $disabled }}>
                                </div>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    <input required class="form-check-input radio-input-2" type="radio"
                                        ...
                                        @if (isset($aspek1_sectionc) && $aspek1_sectionc[$nameIndex] == '2') checked @endif {{ $disabled }}>
                                </div>
                            </td>
                            <!--  @if ($withTB)
<td>
    ...
    @if ($disabled != 'disabled')
        <div class="buy-now">
            <button class="btn btn-primary waves-effect waves-float waves-light" type="button"
                onclick="formsubmit('aspek1_sectionc')">
                Simpan
            </button>
        </div>
    @endif
