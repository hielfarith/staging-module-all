    ...
    <div class="card-header">
        ...
        <div class="d-flex justify-content-start align-items-center mt-2">
            <div class="btn-group mb-1" role="group" aria-label="Basic radio toggle button group">
                <input type="radio" class="btn-check" name="pilihan_carian" id="radio_option1" autocomplete="off" checked />
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-1">
                ...
                <select name="" id="" class="form-select select2" multiple>
                    @for ($year = date('Y') - 5; $year <= date('Y'); $year++) <option value="{{ $year }}">{{ $year }}
                        </option>
                        @endfor
                </select>
            </div>
