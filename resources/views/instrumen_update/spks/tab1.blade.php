...
<form id="forminstrumenspks" novalidate="novalidate">
    <div class="row">
        ...
        <div class="col-md-4 mb-1">
            <input type="text" class="form-control" name="instrumen_name" required
                        ...
                        <div class="col-md-12 mt-1">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control flatpickr flatpickr-input" id="fromDate"
                                        name="pengisian_dari">
                                    <span class="input-group-text" style="background-color: #F3F2F7">Hingga</span>
                                    <input type="date" class="form-control flatpickr flatpickr-input" id="toDate"
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <div class="row mt-1">
                        ...
                        <div class="col-md-8 mt-1">
                            <select class="form-control select2" name="validasi_peranan" required>
                                <option value="">Sila Pilih</option>
                                <option value="PENTADBIR">PENTADBIR </option>
                                <option value="GURU INSTITUSI">GURU INSTITUSI</option>
                            </select>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control flatpickr flatpickr-input"
                                        id="fromDate" name="validasi_dari">
                                    <span class="input-group-text" style="background-color: #F3F2F7">Hingga</span>
                                    <input type="date" class="form-control flatpickr flatpickr-input"
                                        id="toDate" name="validasi_hingga">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 mt-1">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-text" style="background-color: #F3F2F7">Dari</span>
                                    <input type="date" class="form-control flatpickr flatpickr-input"
                                        id="fromDate" name="verfikasi_dari">
                                    <span class="input-group-text" style="background-color: #F3F2F7">Hingga</span>
                                    <input type="date" class="form-control flatpickr flatpickr-input"
                                        id="toDate" name="verfikasi_hingga">
                                </div>
                            </div>
                        </div>
                    </div>
