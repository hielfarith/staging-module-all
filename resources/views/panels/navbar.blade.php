            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        ...
                        <a class="dropdown-item" href="{{ Route::has('user_profile') ? route('user_profile') : 'javascript:void(0)' }}">
                        ...
                        {{-- Below commented code read by artisan command while installing jetstream. !! Do not remove
                        if you want to use jetstream. --}}
        ...
        <li class="auto-suggestion">
            <a class="d-flex align-items-center justify-content-between py-50 w-100" href="{{ url('app/user/view') }}">
                <div class="d-flex align-items-center">
                    ...
                    <div class="search-data">
                        <p class="search-data-title mb-0">{{ Auth::user()->email ?? null }}</p>
