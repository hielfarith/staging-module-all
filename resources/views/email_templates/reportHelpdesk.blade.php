                        ...
                        <td align="center" >
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                <tbody>
                                    ...
                                    {{------- main body ------}}
                                    @php
                                        $reportHelpdesk = $reportHelpdesk ?? null;
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h1 class="table-header">
                                                                Helpdesk Report - {{$reportHelpdesk?->month_type->name ?? "Null"}} {{$reportHelpdesk?->year ?? "Null"}}
                                                            </h1>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left">
                                                            ...
                                                            <br>
                                                            <br>
                                                            Berikut merupakan laporan  {{$reportHelpdesk?->week == 0 ? "bulanan" :  "mingguan"}} bagi sistem {{$reportHelpdesk?->project->name ?? "Null"}} dari {{$reportHelpdesk?->start_date ? $reportHelpdesk->start_date->format('d M Y') : "Null"}} ke {{$reportHelpdesk?->end_date ? $reportHelpdesk->end_date->format('d M Y') : "Null"}}.
                                                            <br>
                                                            <br>
                                                            @if($issueCount == 0)
                                                            Adalah dimaklumkan bahawa tiada aduan menggunakan email, talian hotline dan laman aduan yang diterima pada ini. Oleh itu, tiada penjanaan laporan pada minggu ini.
                                                            <br>
                                                            <br>
                                                            @endif
                                                            Terima Kasih.
