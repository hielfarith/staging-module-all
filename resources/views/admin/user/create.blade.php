...
@section('breadcrumb')
    ...
    @if($type == "internal")
        ...
        <li class="breadcrumb-item"><a>{{__('msg.userinternalcreate')}}</a>
    @else
        <li class="breadcrumb-item"><a href="{{ route('user.index',["type" => $type]) }}">{{__('msg.userexternalindex')}}</a>
        <li class="breadcrumb-item"><a>{{__('msg.userexternalcreate')}}</a>
    @endif
@endsection
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" name="roles[]" value="{{ $role->name }}" type="checkbox" id="roleCB_{{ $role->id }}" />
