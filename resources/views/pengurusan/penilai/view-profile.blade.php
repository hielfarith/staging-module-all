    ...
    <div class="col-xl-12 col-md-12 col-12">
        <div class="card invoice-preview-card">
             ...
             <div>
                ...
                <input type="text" class="form-control" name="nama_pengguna" value="{{$penilai->nama_pengguna}}">
            </div>

            <div>
                <label class="fw-bolder">No Kad Pengenalan:</label>
                <input type="text" class="form-control" name="no_kad" value="{{$penilai->no_kad}}">
            </div>

            <div>
                <label class="fw-bolder"> Emel Peribadi:</label>
                <input type="email" class="form-control" name="email_peribadi" value="{{$penilai->email_peribadi}}">
            </div>

            <div>
                <label class="fw-bolder"> Emel Ketua Jabatan:</label>
                <input type="email" class="form-control" name="email_ketua_jabatan" value="{{$penilai->email_ketua_jabatan}}">
            </div>

            <div>
                <label class="fw-bolder"> Emel Penyelia:</label>
                <input type="email" class="form-control" name="email_penyelia" value="{{$penilai->email_penyelia}}">
            </div>

            <div>
                <label class="fw-bolder"> Agensi/ Kementerian:</label>
                <input type="text" class="form-control" name="agensi_kementerian" value="{{$penilai->agensi_kementerian}}">
            </div>

            <div>
                <label class="fw-bolder"> No Tel Pejabat:</label>
                <input type="text" class="form-control" name="no_tel_pejabat" value="{{$penilai->no_tel_pejabat}}">
            </div>

             <div>
                <label class="fw-bolder"> No Tel Peribadi:</label>
                <input type="text" class="form-control" name="no_tel_peribadi" value="{{$penilai->no_tel_peribadi}}">
            </div>
            
             <div>
                <label class="fw-bolder"> Alamat 1:</label>
                <input type="text" class="form-control" name="alamat1" value="{{$penilai->alamat1}}">
            </div>

             <div>
                <label class="fw-bolder"> Alamat 2:</label>
                <input type="text" class="form-control" name="alamat2" value="{{$penilai->alamat2}}">
            </div>
             ...
             <div>
                ...
                <input type="text" class="form-control" maxlength="6" name="poskod" value="{{$penilai->poskod}}">
            </div>
