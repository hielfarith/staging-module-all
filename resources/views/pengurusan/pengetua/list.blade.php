...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table class="table header_uppercase table-bordered table-hovered" id="TableSenaraiPengetua">
                    <thead>
                        <tr style="color:black; background-color: #ff8e74">
                            <th width="5%">No.</th>
    ...
    <div class="modal fade" id="modal-pengetua-diisi" tabindex="-1" aria-labelledby="modal-pengetua-diisi"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalScrollableTitle">Maklumat Pengerusi/ Pengetua/ Guru Besar/
                        Pengguna</h5>
