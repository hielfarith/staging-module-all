<form id="formahli" novalidate="novalidate">
    <div class="row">
        ...
        <input type="hidden" name="ahli_id" value="{{$ahli->id}}">
        <div class="col-sm-9 col-12 mb-1">
            ...
            <div class="input-group">
                <span class="input-group-text">
                    <select class="form-control select2" name="panggilan" required {{$disabled}}>
        ...
        <div class="col-md-4 mb-1">
            ...
            <select class="form-control select2" name="negeri" id="negeri" required {{$disabled}} onchange="changenegeri(this)">
                ...
                @foreach($states as $state)
                    <option value="{{$state->name}}" @if($ahli->negeri == $state->name) selected @endif>{{$state->name}}</option>
                @endforeach
            </select>
        </div>
