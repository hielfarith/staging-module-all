...
@section('content')
    ...
    <ul class="nav nav-pills nav-first nav-justified" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder" id="penyelarasan-pemarkahan-tab" data-bs-toggle="tab"
                href="#penyelarasan-pemarkahan" aria-controls="penyelarasan-pemarkahan" role="tab"
                aria-selected="false">
                SELARAS <br> MARKAH
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder" id="selaras-nilai-tab" data-bs-toggle="tab"
                href="#selaras-nilai" aria-controls="selaras-nilai" role="tab" aria-selected="false"
                onclick="getJumlah()">
                PENYELARASAN <br> PENILAI
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="text-uppercase text-wrap nav-link fw-bolder" id="kronologi-tab" data-bs-toggle="tab"
                href="#kronologi-tab" aria-controls="kronologi-tab" role="tab" aria-selected="false">
                KRONOLOGI
            </a>
        </li>
    </ul>
    ...
    <div class="card">
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="penyelarasan-pemarkahan" role="tabpanel"
                    aria-labelledby="penyelarasan-pemarkahan-tab">
