<ul class="nav nav-pills nav-second nav-justified" role="tablist">
    <li class="nav-item" role="presentation">
        <a class="text-uppercase text-wrap nav-link fw-bolder active" id="penilai-tab" data-bs-toggle="tab" href="#penilai"
            aria-controls="penilai" role="tab" aria-selected="true">
            PENYELARASAN PENILAI
        </a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="text-uppercase text-wrap nav-link fw-bolder" id="jk-kerja-tab" data-bs-toggle="tab" href="#jk-kerja"
            aria-controls="jk-kerja" role="tab" aria-selected="false">
            PENETAPAN JK KERJA
        </a>
    </li>
</ul>
