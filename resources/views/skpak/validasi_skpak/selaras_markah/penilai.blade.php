  ...
  <table class="table header_uppercase table-bordered table-hovered" id="penyelarasan_penilaian">
    <thead>
        <tr>
            ...
            <th rowspan="2">Skor P1</th>
            <th rowspan="2">Catatan P1</th>
            <th rowspan="2">Gambar</th>
            <th rowspan="2">Skor P2</th>
            <th rowspan="2">Catatan P2</th>
            <th rowspan="2">Gambar</th>
            <th style="width: 10%" rowspan="2">Persetujuan Penyelarasan</th>
			<th style="width: 10%" rowspan="2">Catatan Penyelarasan</th>
        </tr>
    ...
    <tbody>
        @foreach ($penyelarasan_penilaians['sections'] as $section => $subsections)
            <tr>
                <td colspan="11" class="bg-light-primary">{{ $section }}</td>
            </tr>
            @php
                $totalRow = 0;
            @endphp
                    ...
                    <tr>
						...
						<td>
							<select name="" id="" class="form-control select2">
								<option value="" hidden>Persetujuan Penyelarasan</option>
			...
			<tr class="bg-light-success">
                <td colspan="3" class="text-end">Markah Penuh</td>
                <td colspan="3" class="text-start"></td>
                <td colspan="5" class="text-start"></td>
            </tr>
			<tr class="bg-light-success">
                <td colspan="3" class="text-end">Peratus</td>
                <td colspan="3" class="text-start"></td>
                <td colspan="5" class="text-start"></td>
            </tr>
        @endforeach
