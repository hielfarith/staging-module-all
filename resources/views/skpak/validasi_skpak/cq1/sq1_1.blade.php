                ...
                @foreach ($items_1_1 as $index => $item_1_1)
                            ...
                            <td>
                                <div
                                    ...
                                    <input class="form-check-input" type="radio" name="{{ $index }}"
                                        value="{{ $key + 1 }}" required {{ $checked }}
                                        onchange='assignmandatory1("{{ $keyString }}",  this)' {{ $disabled }}>
                                </div>
                                <br>
                    ...
                    <tr class="bg-light-primary">
                        <td colspan="6">
                            ...
                            <input type="file" name="upload_{{ $keyString }}[]"
                                id="uploadfile_{{ $keyString }}" class="form-control" multiple accept="image/*"
                                onchange='filechange1("uploadfile_{{ $keyString }}", "filelist_{{ $keyString }}", this)'
                                {{ $disabled }}>
                            ...
                            @if ($uploadData)
                                ...
                                @endforeach
                                <input type="hidden" name="uploadfile_{{ $keyString }}_list"
                                    value="{{ json_encode($item['upload_' . $keyString]) }}"
                                    id="uploadfile_{{ $keyString }}_list">
                            @endif
                        </td>
                    </tr>
