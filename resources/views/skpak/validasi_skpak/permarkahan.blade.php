...
<input type="hidden" name="skpak_standard_penilaian_id" id="skpak_standard_penilaian_id_permarkahan"
    value="{{ $skpak_standard_penilaian_id }}">

<hr>
@if ($showHantar && empty($disabled))
    <div class="d-flex justify-content-end align-items-center mt-1">
        <button type="button" class="btn {{ $color }} float-right"
            onclick="submitcpermarkahan()">Hantar</button>
    </div>
@endif
</form>
