<style>
    #penyelarasan_penilaian thead th {
        vertical-align: middle;
        text-align: center;
    }

    #penyelarasan_penilaian tbody {
        vertical-align: middle;
        /* text-align: center; */
    }

    #penyelarasan_penilaian table {
        width: 100% !important;
...
<table class="table header_uppercase table-bordered table-hovered" id="penyelarasan_penilaian">
    <thead style="color:black; background-color: #d8bfb0;">
        <tr>
            ...
            <th style="width: 5%" rowspan="2">Skor Penilai</th>
            <th style="width: 20%" rowspan="2">Catatan Penilai</th>
            <th style="width: 20%" rowspan="2">Catatan Penyelaras</th>
        </tr>
