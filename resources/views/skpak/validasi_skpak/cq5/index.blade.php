<ul class="nav nav-pills nav-second nav-justified" role="tablist">
    <li class="nav-item" role="presentation">
        <a class="text-uppercase text-wrap nav-link fw-bolder active" id="sq5-1-tab" data-bs-toggle="tab" href="#sq5-1"
            aria-controls="sq5-1" role="tab" aria-selected="true">
            SQ5.1
        </a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="text-uppercase text-wrap nav-link fw-bolder" id="sq5-2-tab" data-bs-toggle="tab" href="#sq5-2"
            aria-controls="sq5-2" role="tab" aria-selected="false">
            SQ5.2
        </a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="text-uppercase text-wrap nav-link fw-bolder" id="jumlah-sq5-tab" data-bs-toggle="tab"
            href="#jumlah-sq5" aria-controls="jumlah-sq5" role="tab" aria-selected="false"
            onclick="updateJumlah5('itemcq5',{{ $id }})">
            JUMLAH CQ5
        </a>
    </li>
</ul>
